...
class TrainingModel:
    ...
    def training_model(self):
        ...
        try:
            ...
            target_column = "class"
            preprocessor.plot_bar_plot(data,target_column)
            preprocessor.plot_pie_plot(data,target_column)
            ...
            for i in list_of_clusters:
                ...
                best_model_name, best_model = model_finder.get_best_model_mushroom(x_train, y_train, x_test, y_test,cluster_no=str(i))
