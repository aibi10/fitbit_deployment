...
class TrainingModel:
    ...
    def training_model(self):
        ...
        try:
            ...
            scaled_num_df = preprocessor.scale_numerical_columns_credit_default_or_income_prediction(X)

            cat_df=preprocessor.encode_categorical_columns_income_prediction(X)
            ...
            for i in list_of_clusters:
                ...
                best_model_name, best_model = model_finder.get_best_model_income_prediction(x_train,
                                                                                            y_train,
                                                                                            x_test,
                                                                                            y_test,
