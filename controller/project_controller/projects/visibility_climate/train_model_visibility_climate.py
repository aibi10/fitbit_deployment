...
class TrainingModel:
    ...
    def training_model(self):
        ...
        try:
            ...
            data = preprocessor.drop_unnecessary_columns(data, ['DATE', 'Precip', 'WETBULBTEMPF', 'DewPointTempF',
                                                                'StationPressure'])
            ...
            for i in list_of_clusters:
                ...
                best_model_name, best_model = model_finder.get_best_model_zomato_or_fitbit_or_climate_visibility(
