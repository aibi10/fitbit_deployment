    ...
    def training_model(self):
        ...
        try:
            ...
            for i in list_of_clusters:
                ...
                x_train = preprocessor.scale_numerical_columns_bigmart_sales(x_train)
                x_test = preprocessor.scale_numerical_columns_bigmart_sales(x_test)

                model_finder = tuner.ModelFinder(project_id=self.project_id, file_object=self.file_manager,
                                                 logger_object=self.log_writer)  # object initialization

                best_model_name, best_model = model_finder.get_best_model_for_reg(x_train, y_train, x_test,
