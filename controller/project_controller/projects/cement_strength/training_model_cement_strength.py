    ...
    def training_model(self):
        ...
        try:
            ...
            for i in list_of_clusters:
                ...
                best_model_name, best_model = model_finder.get_best_model_for_reg(x_train, y_train, x_test, y_test,
                                                                                  cluster_no=str(i))
